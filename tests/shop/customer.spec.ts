...
test('Profile Edit', async ({page}) => {
    ...
    await page.getByPlaceholder('email@example.com').fill('testUser@gmail.coma');
    ...
    await page.getByPlaceholder('Email', { exact: true }).fill('testUser@gmail.coma');
...
test('Change Password', async ({page}) => {
  ...
  await page.getByPlaceholder('Current Password').fill('testUser123');
  await page.getByPlaceholder('New Password').click();
  await page.getByPlaceholder('New Password').fill('testUser@123');
...
test('Delete Profile', async ({page}) => {
  ...
  await page.getByPlaceholder('Enter your password').fill('testUser123');

...
test('Shipping Settings of Sales', async ({page}) => {
    ...
    await page.getByLabel('Store Name DefaultEnglish').fill('qwertyuiop');
    ...
    await page.getByLabel('Bank Details DefaultEnglish').fill('sjdhjd shdgyuw');
...
test('Shipping Methods of Sales', async ({page}) => {
    ...
    await page.locator('input[name="sales\\[carriers\\]\\[free\\]\\[title\\]"]').fill('Free Shippingdf');
    await page.locator('[id="sales\\[carriers\\]\\[free\\]\\[description\\]"]').click();
    await page.locator('[id="sales\\[carriers\\]\\[free\\]\\[description\\]"]').fill('Free Shippingfd');
    await page.locator('label > div').first().click();
    await page.locator('label > div').first().click();
    await page.locator('[id="sales\\[carriers\\]\\[flatrate\\]\\[title\\]"]').click();
    await page.locator('[id="sales\\[carriers\\]\\[flatrate\\]\\[title\\]"]').fill('Flat Ratefd');
    await page.locator('[id="sales\\[carriers\\]\\[flatrate\\]\\[description\\]"]').click();
    await page.locator('[id="sales\\[carriers\\]\\[flatrate\\]\\[description\\]"]').fill('Flat Rate Shippingfd');
...
test('Payment Methods of Sales', async ({page}) => {
    ...
    await page.locator('[id="sales\\[payment_methods\\]\\[paypal_smart_button\\]\\[title\\]"]').fill('PayPal Smart Buttonfcg');
    await page.locator('[id="sales\\[payment_methods\\]\\[paypal_smart_button\\]\\[description\\]"]').click();
    await page.locator('[id="sales\\[payment_methods\\]\\[paypal_smart_button\\]\\[description\\]"]').click();
    await page.locator('[id="sales\\[payment_methods\\]\\[paypal_smart_button\\]\\[description\\]"]').fill('PayPaldfgdg');
    await page.getByLabel('Client ID Default').click();
    await page.getByLabel('Client ID Default').fill('sbdfgdf');
    await page.getByLabel('Client Secret Default').click();
    await page.getByLabel('Client Secret Default').fill('dfgdrtger');
    await page.getByLabel('Accepted currencies Default').click();
    await page.getByLabel('Accepted currencies Default').fill('fdgrter');
    ...
    await page.locator('[id="sales\\[payment_methods\\]\\[cashondelivery\\]\\[title\\]"]').fill('Cash On Deliverygdgdf');
    await page.locator('[id="sales\\[payment_methods\\]\\[cashondelivery\\]\\[description\\]"]').click();
    await page.locator('[id="sales\\[payment_methods\\]\\[cashondelivery\\]\\[description\\]"]').fill('Cash On Deliverydfgdfger');
    await page.getByLabel('Instructions DefaultEnglish').click();
    await page.getByLabel('Instructions DefaultEnglish').fill('dfgdrt4t');
    ...
    await page.locator('[id="sales\\[payment_methods\\]\\[paypal_standard\\]\\[description\\]"]').fill('PayPal Standardert');
    await page.locator('[id="sales\\[payment_methods\\]\\[paypal_standard\\]\\[title\\]"]').click();
    await page.locator('[id="sales\\[payment_methods\\]\\[paypal_standard\\]\\[title\\]"]').fill('PayPal Standarderter');
    ...
    await page.getByLabel('Send Check to DefaultEnglish').fill('reter');
...
test('Order Settings of Sales', async ({page}) => {
    ...
    await page.getByLabel('Order Number Prefix Default').fill('sdfwee');
    ...
    await page.getByLabel('Order Number Suffix Default').fill('frwerf');
    await page.getByLabel('Order Number Generator Default').click();
    await page.getByLabel('Order Number Generator Default').fill('erwr34');
    ...
    await page.getByLabel('Description Default').fill('dfgter df');
...
test('Invoice Settings of Sales', async ({page}) => {
    ...
    await page.getByLabel('Invoice Number Prefix').fill('asdadas');
    ...
    await page.getByLabel('Invoice Number Suffix').fill('we23');
    await page.getByLabel('Invoice Number Generator').click();
    await page.getByLabel('Invoice Number Generator').fill('we23edw');
    ...
    await page.getByLabel('Footer text DefaultEnglish').fill('fdwsewr');
...
test('Taxes of Sales', async ({page}) => {
    ...
    await page.getByLabel('Default State').fill('asdwe');

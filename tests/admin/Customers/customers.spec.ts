...
test('Create Customer', async ({page}) => {
    ...
    await page.getByPlaceholder('email@example.com').fill('asdghwyug@jksyeuw.wshg');
...
test('Add Address', async ({page}) => {
    ...
    await page.getByPlaceholder('Vat ID').fill('32378uyd');
    await page.getByPlaceholder('First Name').click();
    await page.getByPlaceholder('First Name').fill('yhdguwyeew');
    await page.getByPlaceholder('Last Name').click();
    await page.getByPlaceholder('Last Name').fill('rwereter');
    await page.getByPlaceholder('Email').click();
    await page.getByPlaceholder('Email').fill('rferfce@hsfgyuwe.dfiu');
    await page.getByPlaceholder('Phone').click();
    await page.getByPlaceholder('Phone').fill('236237562374');
    await page.getByPlaceholder('Street Address').click();
    await page.getByPlaceholder('Street Address').fill('jkdsfhueur');
    await page.getByPlaceholder('City').click();
    await page.getByPlaceholder('City').fill('djfnkkerf');
...
test('Add Note', async ({page}) => {
    ...
    await page.getByPlaceholder('Write Your Note here').fill('sjdhiude');

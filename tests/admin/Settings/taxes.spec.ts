...
test('Create Tax Rate', async ({page}) => {
    ...
    await page.getByPlaceholder('State').fill('asdweas');
    ...
    await page.getByPlaceholder('Identifier').fill('sasd');
...
test('Create Tax Category', async ({page}) => {
    ...
    await page.getByPlaceholder('Code').fill('23w');
    await page.getByPlaceholder('Name').click();
    await page.getByPlaceholder('Name').fill('kayuwe');
    await page.getByPlaceholder('Description').click();
    await page.getByPlaceholder('Description').fill('sdfhg hsgd');

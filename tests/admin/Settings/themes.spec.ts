...
test('Create Product Carousel Theme', async ({page}) => {
    ...
    await page.getByPlaceholder('Name').fill('kARTIKEY dUBEY');
    ...
    await page.getByPlaceholder('Title').fill('Product');
...
test('Create Category Carousel Theme', async ({page}) => {
    ...
    await page.getByRole('button', { name: 'Create Theme' }).click();
    await page.getByPlaceholder('Name').click();
    await page.getByPlaceholder('Name').fill('HJGy');
    await page.getByPlaceholder('Sort Order').click();
    ...
    await page.getByPlaceholder('Value').fill('32e2eq');
    await page.locator('button').filter({ hasText: /^Save$/ }).click();
    await page.getByText('Add Filter').click();
...
test('Create Image Slider Theme', async ({page}) => {
    ...
    await page.getByRole('button', { name: 'Create Theme' }).click();
    await page.getByPlaceholder('Name').click();
    await page.getByPlaceholder('Name').fill('asdasd');
    ...
    await page.getByPlaceholder('Image Title').fill('fdgsdf sfds');
...
test('Create Footer Link Theme', async ({page}) => {
    ...
    await page.getByRole('button', { name: 'Create Theme' }).click();
    await page.getByPlaceholder('Name').click();
    await page.getByPlaceholder('Name').fill('hsdguiwe');
    await page.getByPlaceholder('Sort Order').click();
    ...
    await page.getByPlaceholder('Title').click();
    await page.getByPlaceholder('Title').fill('asdw');
...
test('Create Services Content Theme', async ({page}) => {
    ...
    await page.getByRole('button', { name: 'Create Theme' }).click();
    await page.getByPlaceholder('Name').click();
    await page.getByPlaceholder('Name').fill('aSDAS');
    await page.getByPlaceholder('Sort Order').click();
    await page.getByPlaceholder('Sort Order').fill('23');
    ...
    await page.getByPlaceholder('Title').click();
    await page.getByPlaceholder('Title').fill('asdddddddddas');
    await page.getByPlaceholder('Description').click();
    await page.getByPlaceholder('Description').fill('sadqweqw');
    await page.getByPlaceholder('Service Icon Class').click();
    await page.getByPlaceholder('Service Icon Class').fill('dasdqww');
    await page.locator('button').filter({ hasText: /^Save$/ }).click();
    await page.locator('.relative > label').click();
    await page.getByRole('button', { name: 'Save' }).click();
});
...
test('Edit Product Carousel Theme', async ({page}) => {
    ...
    await page.getByRole('link', { name: ' Settings' }).click();
    await page.getByRole('link', { name: 'Themes' }).click();
    await page.locator('div').filter({ hasText: /^13DefaultDefaultproduct_carouselkARTIKEY dUBEY2Active$/ }).locator('span').first().click();
    await page.getByPlaceholder('Name').click();
    await page.getByPlaceholder('Name').fill('kARTIKEY dUBEY');
    await page.getByPlaceholder('Name').press('CapsLock');
    await page.getByPlaceholder('Sort Order').click();

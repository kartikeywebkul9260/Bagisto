...
test('Create Channel', async ({page}) => {
    ...
    await page.getByPlaceholder('Name').fill('dfsfwe');
    await page.getByPlaceholder('Name').click();
    await page.getByPlaceholder('Name').fill('dfsfwe wewe');
    await page.getByPlaceholder('Description', { exact: true }).click();
    await page.getByPlaceholder('Description', { exact: true }).fill('sdfwe ewrwew');
    ...
    await page.getByPlaceholder('https://www.example.com (Don\'').fill('dfsdeew');
    await page.getByPlaceholder('Meta title').click();
    await page.getByPlaceholder('Meta title').fill('werewrwe');
    await page.getByPlaceholder('Meta keywords').click();
    await page.getByPlaceholder('Meta keywords').fill('sdfser');
    await page.getByPlaceholder('Meta description').click();
    await page.getByPlaceholder('Meta description').fill('dsfwerwewe');
    await page.getByPlaceholder('Message').click();
    await page.getByPlaceholder('Message').fill('werwewe');
    await page.getByPlaceholder('Allowed IPs').click();
    await page.getByPlaceholder('Allowed IPs').fill('rwe');

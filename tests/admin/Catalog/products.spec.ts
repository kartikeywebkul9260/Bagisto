...
test('Create Product(simple)', async ({page}) => {
  ...
  await page.locator('#name').fill('ajkshuyi');
  await page.locator('#short_description_ifr').contentFrame().locator('html').click();
  await page.locator('#short_description_ifr').contentFrame().getByLabel('Rich Text Area. Press ALT-0').fill('sdfhsiyu hsdgf');
  await page.locator('#description_ifr').contentFrame().locator('html').click();
  await page.locator('#description_ifr').contentFrame().getByLabel('Rich Text Area. Press ALT-0').fill('skdhff isudiu');
  await page.locator('#meta_title').click();
  await page.locator('#meta_title').fill('sdfiughfier');
  await page.locator('#meta_keywords').click();
  await page.locator('#meta_keywords').fill('sdghfyuweib');
  await page.locator('#meta_description').click();
  await page.locator('#meta_description').fill('sudfgiweuyb');
  ...
  await page.getByPlaceholder('Search by name').click();
  await page.getByPlaceholder('Search by name').fill('shdgfyu');
  await page.getByText('Add Selected Product').click();
...
test('Create Product(downloadable)', async ({page}) => {
  ...
  await page.locator('input[name="title"]').fill('qwwee');
...
test('Create Product(bundle)', async ({page}) => {
  ...
  await page.locator('input[name="label"]').fill('option1');
...
test('Create Product(configurable)', async ({page}) => {
  ...
  await page.locator('select[name="attribute_family_id"]').selectOption('1');
  await page.locator('input[name="sku"]').click();
  await page.locator('input[name="sku"]').fill('12we');
  await page.getByRole('button', { name: 'Save Product' }).click();
  ...
  await page.locator('input[name="name"]').nth(1).fill('Variant 2 6asdsad');
  await page.locator('input[name="sku"]').nth(1).click();
  await page.locator('input[name="sku"]').nth(1).click();
  await page.locator('input[name="sku"]').nth(1).fill('12we-variant-2-6sds');
  await page.locator('input[name="sku"]').nth(1).press('CapsLock');
  await page.locator('input[name="sku"]').nth(1).fill('12we-variant-2-6sdsWDW');

...
test('Create Attribute', async ({page}) => {
  ...
  await page.getByPlaceholder('Admin').fill('sfdatsdf');
  await page.getByPlaceholder('Admin').press('Tab');
  await page.getByPlaceholder('Arabic').fill('ysdaguwy');
  await page.getByPlaceholder('Arabic').press('Tab');
  await page.getByPlaceholder('Bengali').fill('cgyusd');
  await page.getByPlaceholder('Bengali').press('Tab');
  await page.getByPlaceholder('Brazilian Portuguese').fill('hgscbsdy');
  await page.getByPlaceholder('Brazilian Portuguese').press('Tab');
  await page.getByPlaceholder('Chinese').fill('dsuyadtg');
  await page.getByPlaceholder('Chinese').press('Tab');
  await page.getByPlaceholder('Dutch').fill('uysdcfg');
  await page.getByPlaceholder('Dutch').press('Tab');
  await page.getByPlaceholder('English').fill('scyud');
  await page.getByPlaceholder('English').press('Tab');
  await page.getByPlaceholder('French').fill('ysdcgwsa');
  await page.getByPlaceholder('French').press('Tab');
  await page.getByPlaceholder('German').fill('iysd78');
  await page.getByPlaceholder('German').press('Tab');
  await page.getByPlaceholder('Hebrew').fill('hjsdgsyiud');
  await page.getByPlaceholder('Hebrew').press('Tab');
  await page.getByPlaceholder('Hindi').fill('hjsgdis');
  await page.getByPlaceholder('Hindi').press('Tab');
  await page.getByPlaceholder('Italian').fill('hsdgsd');
  await page.getByPlaceholder('Italian').press('Tab');
  await page.getByPlaceholder('Japanese').fill('iyusdcsd');
  await page.getByPlaceholder('Japanese').press('Tab');
  await page.getByPlaceholder('Persian').fill('ghsdgi');
  await page.getByPlaceholder('Persian').press('Tab');
  await page.getByPlaceholder('Polish').fill('bhjsdgiw');
  await page.getByPlaceholder('Polish').press('Tab');
  await page.getByPlaceholder('Russian').fill('hjsdgyiuws uhsd');
  await page.getByPlaceholder('Russian').press('Tab');
  await page.getByPlaceholder('Sinhala').fill('gc whisxg');
  await page.getByPlaceholder('Sinhala').press('Tab');
  await page.getByPlaceholder('Spanish').fill('bwisdcuyw ');
  await page.getByPlaceholder('Spanish').press('Tab');
  await page.getByPlaceholder('Turkish').fill('ciwswi  igwsi');
  await page.getByPlaceholder('Turkish').press('Tab');
  await page.getByPlaceholder('Ukrainian').fill('hbwieyh iuw');
  await page.getByPlaceholder('Ukrainian').press('Tab');
  await page.getByPlaceholder('Attribute Code').fill('dscbwi');
  ...
  await page.locator('input[name="default_value"]').fill('wdfhwbe');

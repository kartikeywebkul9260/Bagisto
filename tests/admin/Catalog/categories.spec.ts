...
test('Create Category', async ({page}) => {
  ...
  await page.getByPlaceholder('Name').fill('SADASDWE');
  ...
  await page.locator('iframe[title="Rich Text Area"]').contentFrame().getByLabel('Rich Text Area. Press ALT-0').fill('ASDAWSD');
  ...
  await page.getByPlaceholder('Meta Title').fill('sdwewew');
  await page.getByPlaceholder('Slug').click();
  await page.getByPlaceholder('Slug').fill('sadasdwewewe');
  await page.getByPlaceholder('Meta Keywords').click();
  await page.getByPlaceholder('Meta Keywords').fill('qrqwe');
  await page.getByPlaceholder('Meta Description').click();
  await page.getByPlaceholder('Meta Description').fill('wer343');
